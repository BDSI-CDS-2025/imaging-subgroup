...
# Use only the ALL_IMG dataset
DATASET_NAME = "ALL_IMG"
TARGETS = ['ER', 'PR', 'HER2']
...
def main():
    print(f"\n=== Processing ALL_IMG dataset ===")
    setup = SETUP[DATASET_NAME]
    for target in TARGETS:
        ...
        '''
        print("Starting SVM BayesSearchCV...")
        svm_bayes = BayesSearchCV(
            ...
            n_jobs=-1,
            random_state=42,
            verbose=3  # More verbose output
        )
        print("Search complete. Starting fit.")
        svm_bayes.fit(X, y)
        ...
        print("Starting cross_val_predict (labels)...")
        ...
        print("cross_val_predict complete.")

        print("Skipping BayesSearchCV. Training default SVM...")
        ...
        # Save hyperparameters for this target
        ...
        with open(results_dir / "metrics_only_svm.json", "w") as f:
